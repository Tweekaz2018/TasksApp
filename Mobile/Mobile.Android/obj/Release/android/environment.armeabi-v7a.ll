; ModuleID = 'obj/Release/android/environment.armeabi-v7a.ll'
source_filename = "obj/Release/android/environment.armeabi-v7a.ll"
...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"498fa2d8-fb56-4afb-90a3-76d675565276\00", align 1
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100676750, ; jnienv_initialize_method_token
	i32 100676749, ; jnienv_registerjninatives_method_token
...
@assembly_store_bundled_assemblies = local_unnamed_addr global [92 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
